...
public class PantallaRegistrarVotante extends javax.swing.JFrame {

    public PantallaRegistrarVotante() {
        initComponents();
        txtVoto.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/votar(2).png"))); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(txtVoto, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnRegistrar.setBackground(new java.awt.Color(130, 224, 170));
        btnRegistrar.setFont(new java.awt.Font("Oswald", 0, 14)); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if(DNI == 0 || txtDNI.getText().length()>8){
            guardar=false;
            mensaje+="Escriba un DNI VALIDA\n";
        }        
        if(nombre.isEmpty()){
            guardar = false;
        ...
        if(direccion.isEmpty()){
         ...
         if(guardar){
           ...
           control.insertar(DNI,nombre, AP, AM, direccion, voto);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaRegistrarVotante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaRegistrarVotante().setVisible(true);
            }
        });
    }
