...
public class PantallaElectoral extends javax.swing.JFrame {
    ...
    private void btnAceptarDNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarDNIActionPerformed
     /* if(campoDNI.getText().length()==8){
          try {
              ...
              Registry register=LocateRegistry.getRegistry("192.168.1.64",1099);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Registry register=LocateRegistry.getRegistry("1192.168.134.81",1099);
...
/*
        Registry register;
        try {
            register = LocateRegistry.getRegistry("192.168.134.81",4070);
